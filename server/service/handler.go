...
func attachFleetAPIRoutes(r *mux.Router, svc fleet.Service, config config.FleetConfig,
	...
	// OpenFrame fork: host-level policy targeting (FLEET_OPENFRAME_MODE).
	...
	// OpenFrame fork: host-level query targeting (FLEET_OPENFRAME_MODE). Path kept as /queries for OpenFrame API compatibility.
