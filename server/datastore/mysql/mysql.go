...
// MigrateOpenframe runs openframe-specific schema migrations, tracked independently
// from upstream Fleet's tables/data migration clients. See openframe/docs/migrations.md.
