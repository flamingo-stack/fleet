...
func Up_20251203170808(tx *sql.Tx) error {
	...
	if fkExists(tx, "certificate_templates", "certificate_templates_ibfk_1") {
		if _, err := tx.Exec(
			`ALTER TABLE certificate_templates DROP FOREIGN KEY certificate_templates_ibfk_1;`); err != nil {
