...
func Up_20240802101043(tx *sql.Tx) error {
	...
	if !columnExists(tx, "host_software_installs", "host_deleted_at") {
		if _, err := tx.Exec("ALTER TABLE host_software_installs ADD COLUMN host_deleted_at timestamp NULL DEFAULT NULL"); err != nil {
