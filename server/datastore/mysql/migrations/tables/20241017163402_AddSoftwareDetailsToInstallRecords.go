...
func Up_20241017163402(tx *sql.Tx) error {
	...
	if !columnExists(tx, "host_software_installs", "installer_filename") {
	...
	if !columnExists(tx, "host_software_installs", "version") {
	...
	if !columnExists(tx, "host_software_installs", "software_title_id") {
	...
	if !columnExists(tx, "host_software_installs", "software_title_name") {
	...
	if columnExists(tx, "host_software_installs", "software_installer_id") {
	...
	if fkExists(tx, "host_software_installs", "fk_host_software_installs_installer_id") {
	...
	if !fkExists(tx, "host_software_installs", "fk_host_software_installs_software_title_id") {
