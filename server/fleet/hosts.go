...
type Host struct {
	...
	OsqueryHostID    *string   `json:"osquery_host_id" db:"osquery_host_id" csv:"osquery_host_id"`       // OPENFRAME(osquery-host-id): expose osquery_host_id in API (upstream json:"-") — openframe/docs/api-expose-osquery-host-id.md
