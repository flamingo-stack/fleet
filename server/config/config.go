...
type RedisConfig struct {
	...
	// KeyPrefix namespaces every Redis key and pub/sub channel when sharing one Redis
	// across tenants (FLEET_REDIS_KEY_PREFIX, typically the tenant ID). OpenFrame fork.
...
type ServerConfig struct {
	...
	// OpenFrame fork: query_results TTL cleanup. See openframe/docs/query-results-ttl-cleanup.md.
